      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="card overflow-hidden">
          ...
          <div className="px-8 pb-8 relative">
            <div className="absolute -top-16 w-32 h-32 bg-white dark:bg-gray-800 rounded-full border-4 border-white dark:border-gray-800 flex items-center justify-center text-indigo-600 dark:text-indigo-400 text-4xl font-bold shadow-lg">
              {formData.firstName.charAt(0) || user?.fullName?.charAt(0) || 'U'}
            </div>
            ...
            <div className="mt-20">
              ...
              {!isEditMode && profile ? (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div>
                    <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400">Enrolled Course</h3>
                    <p className="mt-1 text-lg font-medium text-gray-900 dark:text-white">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  {!profile && (
                    <div className="bg-yellow-50 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-200 p-4 rounded-xl text-sm font-medium mb-6">
                      Welcome! Please complete your student profile setup to continue.
                    </div>
                  )}
                  ...
                  <div>
                    ...
                    <input type="email" name="email" required className="input-field bg-gray-100 dark:bg-gray-800 cursor-not-allowed" value={formData.email} readOnly />
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input type="text" name="course" required className="input-field" value={formData.course} onChange={handleChange} />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Age</label>
                      <input type="number" name="age" required min="16" max="100" className="input-field" value={formData.age} onChange={handleChange} />
                    </div>
                  </div>
